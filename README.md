...
> **Important Notice**: This code repository is directly related to the paper **"Enhanced Road Infrastructure Defect Detection via Attention-Based Visual Inspection"** submitted to _The Visual Computer_ journal.
...
- `D20`: Alligator Crack
- `D40`: Pothole
- `crack_on_line`: Crack in Pavement Marking _(New)_
- `guardrail`: Damaged Guardrail _(New)_
- `traffic_sign`: Damaged Traffic Sign _(New)_
